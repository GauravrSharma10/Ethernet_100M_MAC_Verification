...
class wishbone_master_driver extends uvm_driver #(uvm_sequence_item);
  ...
  function void build_phase(uvm_phase phase);
    ...
    if(!uvm_config_db#(virtual wishbone_master_interface)::get(this, "", "vif", vif))
      `uvm_fatal("NOVIF", "Virtual interface not set for wishbone_master_driver")
  endfunction
