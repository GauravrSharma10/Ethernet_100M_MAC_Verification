///////////////////////////////////////////////////////////////////////////////////
// Filename: wishbone_slave_agent.sv
//
// Author:
// Date: 12/12/2025
// Revision: 1
...
//
// Description: Wishbone Slave Agent component.
// Dependencies:
// Notes:
//////////////////////////////////////////////////////////////////////////////////
...
class wishbone_slave_agent extends uvm_agent;
  ...
  ////////////////////////////////////////////////////////////////////////
  // function name : new
  // argument : string name = "wishbone_slave_agent", uvm_component parent = null
  // description : Class constructor
  ////////////////////////////////////////////////////////////////////////
  function new(string name = "wishbone_slave_agent", uvm_component parent = null);
  ...
  function void build_phase(uvm_phase phase);
    ...
    monitor = wishbone_slave_monitor::type_id::create("monitor", this);
